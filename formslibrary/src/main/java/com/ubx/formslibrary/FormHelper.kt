...
class FormHelper(private val context: Context, appName: String): FormsInterface {
    ...
    override fun setPadding(left: Int, top: Int, right: Int, bottom: Int) {
        FormParamHelper.setPadding(left, top, right, bottom)
    }
    ...
    override fun setMargins(left: Int, top: Int, right: Int, bottom: Int) {
        FormParamHelper.setMargins(left, top, right, bottom)
    }

    /**
     * Add (or not) outline input fields
     *
     * @param isOutlined outline added to fields if true
     */
    override fun outlineFields(isOutlined: Boolean) {
        FormParamHelper.outlineFields(isOutlined)
    }
    ...
    override fun addPageRow(baseWidgets: MutableList<BaseWidget>) {
        FormParamHelper.addRow(baseWidgets)
    }
    ...
    override fun addText(label: String, width: Int, height: Int): TextWidget {
        return FormParamHelper.addText(label, width, height, true)
    }
    ...
    override fun addTextInRow(label: String, width: Int, height: Int): TextWidget {
        return FormParamHelper.addText(label, width, height, false)
    }
    ...
    override fun addInput(
        ...
        return FormParamHelper.addInput(
    ...
    override fun addNextButton(label: String, width: Int, height: Int): ButtonWidget {
        return FormParamHelper.addNextButton(label, width, height, true)
    }
    ...
    override fun addNextButtonInRow(label: String, width: Int, height: Int): ButtonWidget {
        return FormParamHelper.addNextButton(label, width, height, false)
    }
    ...
    override fun addButton(label: String, listener: CustomListener,
        ...
        return FormParamHelper.addButton(label, listener, width, height, true)
    }
    ...
    override fun addButtonInRow(label: String, listener: CustomListener,
                                width: Int, height: Int): ButtonWidget {
        return FormParamHelper.addButton(label, listener, width, height, false)
    }
    ...
    override fun addDate(
        ...
        return FormParamHelper.addDate(label, key, isRequired, width, height, true)
    }
    ...
    override fun addDateInRow(
        ...
        return FormParamHelper.addDate(label, key, isRequired, width, height, false)
    }
    ...
    override fun addDropdown(
        ...
        return FormParamHelper.addDropdown(label, options, key, isRequired, width, height, true)
    }
    ...
    override fun addDropdownInRow(
        ...
        return FormParamHelper.addDropdown(label, options, key, isRequired, width, height, false)
    }
    ...
    override fun addList(
        ...
        return FormParamHelper.addList(label, options, key, isRequired, width, height, true)
    }
    ...
    override fun addListInRow(
        ...
        return FormParamHelper.addList(label, options, key, isRequired, width, height, false)
    }
    ...
    override fun addMedia(
        ...
        return FormParamHelper.addMedia(label, key, isRequired, width, height, true)
    }
    ...
    override fun addMediaInRow(
        ...
        return FormParamHelper.addMedia(label, key, isRequired, width, height, false)
    }
    ...
    override fun addChecklist(
        ...
        return FormParamHelper.addChecklist(label, options, key, isRequired, width, height, true)
    }
    ...
    override fun addChecklistInRow(
        ...
        return FormParamHelper.addChecklist(label, options, key, isRequired, width, height, false)
    }
    ...
    override fun addSwitch(
        ...
        return FormParamHelper.addSwitch(label, key, isRequired, width, height, true)
    }
    ...
    override fun addSwitchInRow(
        ...
        return FormParamHelper.addSwitch(label, key, isRequired, width, height, false)
    }
